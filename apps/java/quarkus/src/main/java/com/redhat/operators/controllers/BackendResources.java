        ...
        if(potentialDeployment.isEmpty()){
            Deployment deployment1 = new DeploymentBuilder()
                    ...
                    .withNewSpec()
                        ...
                        .withNewSelector()
                            .withMatchLabels(Map.of("tier", "backend","app", "visitors","app.kubernetes.io/managed-by","visitors-operator"))
                        .endSelector()
                        .withNewTemplate()
                            .withNewMetadata()
                                .addToLabels("app", "visitors")
                                .addToLabels("tier", "backend")
                                .addToLabels("app.kubernetes.io/managed-by","visitors-operator")
                            .endMetadata()
                        .withNewSpec()
                            .addNewContainer()
                                .withName("visitors-backend")
        ...
        if(checkServiceExists("visitors-backend-service").isEmpty()){
            Service service = new ServiceBuilder()
                .withNewMetadata()
                    ...
                    .withLabels(Map.of("tier", "backend","app", "visitors","app.kubernetes.io/managed-by","visitors-operator"))
                .endMetadata()
                .withNewSpec()
                    .withType("NodePort")
                    .addNewPort()
